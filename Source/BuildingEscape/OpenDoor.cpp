...
void UOpenDoor::BeginPlay()
{
	...
	if (!PressurePlate)
	{
		UE_LOG(LogTemp, Error, TEXT("Nullpointer error: PressurePlate not set on %s!"), *GetOwner()->GetName());
	}
...
void UOpenDoor::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
	...
	if (TotalMassOfActors() >= TargetWeight)
	{
		OpenDoor(DeltaTime);
	...
	//UE_LOG(LogTemp, Display, TEXT("%f time has elapsed"), DoorLastOpened);
}
